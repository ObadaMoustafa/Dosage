 ...
 */
final class Version20260127120007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE voorraad_item (id BLOB NOT NULL, name VARCHAR(255) NOT NULL, strips_count INTEGER NOT NULL, pills_per_strip INTEGER NOT NULL, threshold INTEGER NOT NULL, status VARCHAR(20) NOT NULL, last_updated DATETIME NOT NULL, gebruiker_id BLOB NOT NULL, PRIMARY KEY (id), CONSTRAINT FK_869FC28A9C92A3DF FOREIGN KEY (gebruiker_id) REFERENCES gebruikers (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
